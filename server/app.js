...
db.once('open', function () {
 ...
 // Create Schema to format each campaign document
...
var rayton = new Campaign({
    ...
    "Pitch" : "Solar panel manufacturing technology for photovoltaic electricity.",
    "Target" : "200,000",
...
var piper = new Campaign({
    ...
    "Pitch" : "Play Minecraft, Learn to Build Computers.",
    "Target" : "25,000",
    "Location" : "Reno, NV",
    "Industry" : "Technology",
...
var instamic = new Campaign({
    ...
    "Pitch" : "The Smartest and Smallest Microphone",
    "Target" : "75,000",
    "Location" : "Denver, CO",
    "Industry" : "Gadget",
...
var metronome = new Campaign({
    "Name" : "Metronome Technologies",
        "Description" : "This campaign will build a new fast and affordable smartphone",
        "Pitch" : "This campaign will build a new fast and affordable smartphone.",
        "Target" : "150,000",
